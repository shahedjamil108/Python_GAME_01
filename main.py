...
SPACE = pygame.transform.scale(pygame.image.load(os.path.join('Assets', 'space.png')), (w,h))
...
def yellow_handle_movement(keys_pressed, yellow):
    ...
    if keys_pressed[pygame.K_w] and yellow.y - VEL > 0:
            yellow.y -= VEL
    if keys_pressed[pygame.K_s] and yellow.y + VEL + yellow.height < h:
            yellow.y += VEL
...
def red_handle_movement(keys_pressed, red):
    ...
    if keys_pressed[pygame.K_UP] and red.y - VEL > 0:
            red.y -= VEL
    if keys_pressed[pygame.K_DOWN] and red.y + VEL + red.height < h:
            red.y += VEL
